        ...
        <div class="login-wrapper">
            <div class="login-container">
                <div class="login-form">
                    ...
                    <form method="post" action="admin.php" class="login-form-content">
                        ...
                        <div class="form-actions">
                            <button type="submit" name="logowanie" class="btn btn-primary">
                                Zaloguj
                            </button>
                            <a href="../contact.php?action=remind" class="btn btn-secondary">
                                Zapomniałeś hasła?
                            </a>
                        </div>
                    </form>
   ...
   if (isset($_GET['action'])) {
       ...
       switch($_GET['action']) {
           ...
           case 'delete_category':
               $id = isset($_GET['id']) ? (int)$_GET['id'] : 0;
               if ($categoryManager->UsunKategorie($id)) {
                   header('Location: admin.php?action=categories');
                   exit();
               }
               echo '<div class="error">Błąd podczas usuwania kategorii.</div>';
               break;
